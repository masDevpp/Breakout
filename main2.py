...
class EpisodeMemory():
    def __init__(self, min_size, max_size, do_preprocess, state_seq_length, skip_frame):
        self.states = []
        self.actions = []
        self.rewards = []
        self.terminals = []
...
def main():
    ...
    episode_memory = EpisodeMemory(learn_start, memory_size, True, num_states_to_hold, skip_frame)
